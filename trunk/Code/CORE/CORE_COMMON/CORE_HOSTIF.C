...
void Data_To_Port(BYTE data_byte)
{
	KBHIKDOR = data_byte;
}

void Data_To_Port_nWait(BYTE data_byte)
{
    Data_To_Port(data_byte);
...
{
    if( KBPendingRXCount >= 6 )  return; //BROOKE0000: modify > to >=
